...
def test_matches():
    ...
    with patch('src.matches.text', return_value="SELECT COUNT(*) FROM raw_transactions") as mock_text:
        ...
        with patch('sqlalchemy.orm.sessionmaker', return_value=lambda: mock_session) as MockedSession:
